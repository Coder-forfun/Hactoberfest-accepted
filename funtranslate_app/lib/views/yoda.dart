...
class _YodaState extends State<Yoda> {
   ...
   apicall()async{
    ...
    response = await http.get(Uri.parse("https://api.funtranslations.com/translate/yoda.json?text=$textEntered"));
     ...
     return  Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          Container(
            child: 
            dataResponse==null? Text("Data is Loading...Please Wait")
